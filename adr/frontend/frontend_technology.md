# ADR: Use React as the Frontend Technology
...
- `Next.js` – Rejected because full server-side rendering (SSR) and SEO were unnecessary for the dashboard-heavy parts. only landing pages required SEO. Sitecore supports Nextjs natively.
